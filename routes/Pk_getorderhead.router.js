...
router.get('/v1/OnlineJournal/pk-getAll/:getdate',OrderHeadController.Pk_getAll_Onlinejournal);
router.get('/v1/OnlineJournal/pk-getComplete/:getdate',OrderHeadController.Pk_getComplete_Onlinejournal);
router.get('/v1/OnlineJournal/pk-getNotComplete/:getdate',OrderHeadController.Pk_getNotComplete_Onlinejournal);
